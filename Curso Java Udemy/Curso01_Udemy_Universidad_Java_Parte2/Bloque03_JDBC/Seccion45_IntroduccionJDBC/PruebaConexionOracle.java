...
public class PruebaConexionOracle 
{
  public static void main(String[] args) 
  {
    ...
    // Se crea un objeto de tipo "Conexion_BBDD" que se va a utilizar para la conexión con la BBDD indicando que la BBDD va a ser Oracle.
    ...
    try 
    {
      ...
      // Se llama al método que realiza la conexión con la BBDD de Oracle.
      Connection conexion = conexionOracle.crearConexionBBDD();
