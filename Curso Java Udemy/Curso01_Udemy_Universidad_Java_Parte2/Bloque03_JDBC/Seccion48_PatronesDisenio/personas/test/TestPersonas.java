...
package Seccion48_PatronesDisenio.personas.test;
...
import Seccion48_PatronesDisenio.personas.jdbc.PersonaDaoJDBC;
import Seccion48_PatronesDisenio.personas.jdbc.IPersonaDao;
...
public class TestPersonas 
{
	...
	public static void consultar(Connection conexion) throws SQLException
	{
		...
		// Se crea un objeto de tipo IPersonaDao.
		...
		List<PersonaDto> listaPersonas = personaDAO.consultarPersonas();
  	...
  	System.out.println("\n-----------------------------");
		...
		for (PersonaDto personas : listaPersonas) 
		{
	...
	public static void insertar(Connection conexion, PersonaDto nuevaPersona) throws SQLException
	{
	...
	public static void actualizar(Connection conexion, PersonaDto nuevosDatosPersona) throws SQLException
	{
	...
	public static void eliminar(Connection conexion, PersonaDto personaEliminar) throws SQLException
	{
